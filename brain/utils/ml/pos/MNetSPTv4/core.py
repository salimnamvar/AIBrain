"""MoveNet-Single-Pose-Thunder-v4 Pose Estimator
...
from brain.utils.ml.pos import OVSPosEstModel
...
class MNetSPTv4(OVSPosEstModel):
    ...
    def _postproc(self, a_preds: np.ndarray, a_box: BBox2D) -> Pose2D:
        ...
        # Create Pose2D
        pose = Pose2D.from_xy(a_coordinates=kps)
