"""PVBDC0078 Person Detector

This module implements a Person Detector based on the person-vehicle-bike-detection-crossroad-0078 model.
"""
...
from aib.legacy.det.util import OVObjDetModel


# endregion Imported Dependencies


class PVBDC0078(OVObjDetModel):
    """PVBDC0078 Person Detector

    This class extends the OVPrsDetModel class to implement a person detector based on the
    person-vehicle-bike-detection-crossroad-0078 model.
    ...
    def __init__(
        ...
        """Initialize the PVBDC0078 Person Detector.
    ...
    def _postproc(self, a_preds: np.ndarray, a_image: Image2D) -> BBox2DList:
        ...
        if a_preds is not None and len(a_preds[0][0]):
            ...
            # Select person bounding boxes.
            preds = preds[preds[:, 1] == 1.0]
